...
namespace ImGui
{
    ...
    IMGUI_API bool          BeginTabItemWithImage(ImTextureID texture, ImVec2 imageSizeInTab, const char* label, bool* p_open = NULL, ImGuiTabItemFlags flags = 0);// not part of Ocornut's ImGui !!!! Same as above but displays an image instead of text

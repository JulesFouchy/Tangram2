...
public:
	...
	static void FillParametersList(entt::registry& R, entt::entity shaderEntity, std::vector<Parameter*>& parametersList);
...
private:
	...
	static Parameter* CreateParameterFromLine(entt::registry& R, const std::string& line, int glShaderID);
	template <typename T>
